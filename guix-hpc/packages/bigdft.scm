...
(define suite-source-page
  "https://gitlab.com/l_sim/bigdft-suite")

(define-public suite-source
  (origin
    (method git-fetch)
    (uri (git-reference (url suite-source-page)
...
(define-public gain
  (package
    ...
    (source
     (origin
      (method git-fetch)
      (uri (git-reference (url "https://gitlab.inria.fr/numpex-pc5-wp3/gain")
                          (commit (string-append "v" version))))
      (sha256 (base32 "1rz5m5nqd687qmd471zf522zixcn0a5cjgswv8vraqq0c8ppxyc7"))))
    (build-system gnu-build-system)
