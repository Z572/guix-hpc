...
(define feelpp-commit
  "808bca30d880016ba8915900f9fc6de484aea457")
...
(define-public feel++
  (package
    ...
    (inputs (list openmpi
                  ...
                  ;; Python deps
                  python
                  python-wrapper ;python -> python3 compat
                  python-petsc4py
                  python-mpi4py
                  python-sympy
                  pybind11))
    (arguments
     (list
      ...
      #:parallel-tests? #f ;tests are already parallel
      ;; #:tests? #f ;FIXME
      #:phases #~(modify-phases %standard-phases
                   ;; Otherwise fails with linker errors:
                   ;; ld: ../../feel/libfeelpp.so.1.0.0: undefined reference to `__kmpc_fork_call'
    ...
    (description
     "Feel++ is a library which allows to solve a large range of
