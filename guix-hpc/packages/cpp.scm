...
(define kokkos-kernels-for-ddc-and-gyselalibxx
  (package/inherit kokkos-kernels
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
             (url "https://github.com/yasahi-hpc/kokkos-kernels")
             (commit "5c003ce1e1182b0d79c2e285edb677f34596020b")))
       (sha256
        (base32 "0nz6msk174agxpk4sr647qgy53lr3avjrpl790rzgf0b06aqdl3n"))))))
...
(define-public ddc
  (let ((commit "e9e1435eae2d4a56243e167c49026035277418bb") ;; Commit from 12-09-2024.
    ...
    (package
      ...
      (build-system cmake-build-system)
      (inputs (list kokkos
                    kokkos-kernels-for-ddc-and-gyselalibxx
                    mdspan
                    fftw
                    fftwf
                    pdi
