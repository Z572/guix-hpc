...
(define (make-rocm-comgr rocm-device-libs llvm-rocm lld-rocm clang-rocm)
    (package
        ...
        (source (rocm-comgr-origin version))
        ...
        (arguments
            (list
                ...
                #~(modify-phases %standard-phases
                    (add-after 'unpack 'chdir (lambda _ (chdir "lib/comgr"))))))
        (inputs (list rocm-device-libs))
        (native-inputs (list llvm-rocm lld-rocm clang-rocm))
        (synopsis "The ROCm Code Object Manager")
        (description "The Comgr library provides APIs for compiling and inspecting AMDGPU code objects.")
        (home-page "https://github.com/RadeonOpenCompute/ROCm-CompilerSupport")
        (license ncsa)))

(define-public rocm-comgr-5.7 (make-rocm-comgr rocm-device-libs-5.7 llvm-rocm-5.7 lld-rocm-5.7 clang-rocm-5.7))
(define-public rocm-comgr-5.6 (make-rocm-comgr rocm-device-libs-5.6 llvm-rocm-5.6 lld-rocm-5.6 clang-rocm-5.6))
(define-public rocm-comgr-5.5 (make-rocm-comgr rocm-device-libs-5.5 llvm-rocm-5.5 lld-rocm-5.5 clang-rocm-5.5))
(define-public rocm-comgr-5.4 (make-rocm-comgr rocm-device-libs-5.4 llvm-rocm-5.4 lld-rocm-5.4 clang-rocm-5.4))
(define-public rocm-comgr-5.3 (make-rocm-comgr rocm-device-libs-5.3 llvm-rocm-5.3 lld-rocm-5.3 clang-rocm-5.3))
...
(define-public hip-5.7 (make-hip "5.7.1"))
(define-public hip-5.6 (make-hip "5.6.1"))
...
(define-public hipcc-5.7 (make-hipcc rocminfo-5.7 rocm-toolchain-5.7))
(define-public hipcc-5.6 (make-hipcc rocminfo-5.6 rocm-toolchain-5.6))
    ...
    (package
        ...
        (arguments
            (list
                ...
                #:configure-flags
                #~(list
                    (string-append "-DHIP_COMMON_DIR=" #$hip)
                    (string-append "-DHIPCC_BIN_DIR=" #$hipcc "/bin")
                    "-DCLR_BUILD_HIP=ON"
                    "-DCLR_BUILD_OCL=OFF"
...
(define-public hipamd-5.7 (make-clr-hipamd hip-5.7 hipcc-5.7 rocm-comgr-5.7))
(define-public hipamd-5.6 (make-clr-hipamd hip-5.6 hipcc-5.6 rocm-comgr-5.6))
...
(define-public rocclr-src-5.3 (rocclr-origin "5.3.3"))
...
(define-public rocm-opencl-runtime-src-5.3 (rocm-opencl-runtime-origin "5.3.3"))
...
(define-public hip-5.5 (make-hip-headers rocminfo-5.5 rocm-toolchain-5.5))
(define-public hip-5.4 (make-hip-headers rocminfo-5.4 rocm-toolchain-5.4))
(define-public hip-5.3 (make-hip-headers rocminfo-5.3 rocm-toolchain-5.3))
    ...
    (package
        ...
        (arguments
            (list
                ...
                #~(list
                    (string-append "-DHIP_COMMON_DIR=" #$hip)
                    (string-append "-DROCCLR_PATH=" #$rocclr)
                    (string-append "-DAMD_OPENCL_PATH=" #$rocm-opencl)
                    "-D__HIP_ENABLE_PCH=OFF"
                    "-DHIP_PLATFORM=amd")
                #:phases
                #~(modify-phases %standard-phases
        ...
        (description "This repository provides HIP implementation specifically for the AMD platform.")
        (home-page "https://github.com/ROCm-Developer-Tools/hipamd")
        (license expat)))

(define-public hipamd-5.5 (make-hipamd hip-5.5 rocm-comgr-5.5 rocclr-src-5.5 rocm-opencl-runtime-src-5.5))
(define-public hipamd-5.4 (make-hipamd hip-5.4 rocm-comgr-5.4 rocclr-src-5.4 rocm-opencl-runtime-src-5.4))
(define-public hipamd-5.3 (make-hipamd hip-5.3 rocm-comgr-5.3 rocclr-src-5.3 rocm-opencl-runtime-src-5.3))
...
(define-public rocm-cmake-5.7 (make-rocm-cmake "5.7.1"))
(define-public rocm-cmake-5.6 (make-rocm-cmake "5.6.1"))
(define-public rocm-cmake-5.5 (make-rocm-cmake "5.5.1"))
(define-public rocm-cmake-5.4 (make-rocm-cmake "5.4.4"))
(define-public rocm-cmake-5.3 (make-rocm-cmake "5.3.3"))
