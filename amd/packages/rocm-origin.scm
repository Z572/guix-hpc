...
(define rocm-patches
    `(
        ...
        ; tensile
        (("tensile" "5.7.1") . ("amd/rocm/patches/tensile-5.3.3-copy-if-not-exist.patch"))
        (("tensile" "5.6.1") . ("amd/rocm/patches/tensile-5.3.3-copy-if-not-exist.patch"))
        (("tensile" "5.5.1") . ("amd/rocm/patches/tensile-5.3.3-copy-if-not-exist.patch"))
        (("tensile" "5.4.4") . ("amd/rocm/patches/tensile-5.3.3-copy-if-not-exist.patch"))
        (("tensile" "5.3.3") . ("amd/rocm/patches/tensile-5.3.3-copy-if-not-exist.patch"))
        ; rocblas
        (("rocblas" "5.6.1") . ("amd/rocm/patches/rocblas-5.6.1.patch"))
        (("rocblas" "5.5.1") . ("amd/rocm/patches/rocblas-5.5.1.patch"))
        (("rocblas" "5.4.4") . ("amd/rocm/patches/rocblas-5.4.4.patch"))
        (("rocblas" "5.3.3") . ("amd/rocm/patches/rocblas-5.3.3.patch"))
    )
)
